  ...
  return (
    <div className="flex flex-col items-center min-h-screen justify-between">
      ...
      <main className="flex flex-col items-center space-y-8 max-w-4xl w-full py-16">
        <h1 className="font-bold text-3xl text-scary-gray capitalize underline">Formato de Denuncia</h1>

        <form className="flex flex-col w-full items-center space-y-12">
          {/* Datos del Denunciante */}
          <fieldset  className="relative flex flex-col bg-gray-200 pt-2 pb-7 px-12 w-full space-y-4 text-lg">
            <legend className="text-2xl font-semibold">Datos Generales del Denunciante</legend>
            
            <div className="flex flex-row w-full justify-between items-center">
              <label htmlFor="whistleblower-name" className="font-semibold w-64 mr-4">*Nombre Completo</label>
              <input type="text" name="whistleblower-name" className="w-full px-5 py-1 shadow-sm border-gray-300 rounded-md"/>
            </div>

            <div className="flex flex-row w-full justify-between items-center">
              <label htmlFor="whistleblower-phone" className="font-semibold w-64 mr-4">Teléfono</label>
              <input type="tel" name="whistleblower-phone" className="w-full px-5 py-1 shadow-sm border-gray-300 rounded-md"/>
            </div>

            <div className="flex flex-row w-full justify-between items-center">
              <label htmlFor="whistleblower-email" className="font-semibold w-64 mr-4">Correo electrónico</label>
              <input type="email" name="whistleblower-email" className="w-full px-5 py-1 shadow-sm border-gray-300 rounded-md"/>
            </div>

            <div className="flex flex-row w-full justify-between items-center">
              <label htmlFor="whistleblower-anonymous" className="font-semibold w-64 mr-4">¿Desea que sus datos sean anónimos?</label>
          ...
          <fieldset className="flex flex-row text-xl">
            <label htmlFor="denounced-exist" className="font-semibold w-64 mr-4">¿Existe un denunciado?</label>
            <div className="flex flex-row space-x-4 w-full">
              <div className="flex items-center">
          ...
          <fieldset  className="relative flex flex-col bg-gray-200 pt-2 pb-7 px-12 w-full space-y-4 text-lg">
            <legend className="text-2xl font-semibold">Datos Generales del Denunciado</legend>
            
            <div className="flex flex-row w-full justify-between items-center">
              <label htmlFor="denounced-name" className="font-semibold w-64 mr-4">*Nombre</label>
              <input type="text" name="denounced-name" className="w-full px-5 py-1 shadow-sm border-gray-300 rounded-md"/>
            </div>

            <div className="flex flex-row w-full justify-between items-center">
              <label htmlFor="denounced-person-type" className="font-semibold w-64 mr-4">*Tipo de Persona</label>
              <div className="flex flex-row space-x-4 w-full">
                <div className="flex items-center">
            ...
            <div className="flex flex-row w-full justify-between items-center">
              <label htmlFor="denounced-direction" className="font-semibold w-64 mr-4">Dirección</label>
              <input type="text" name="denounced-direction" className="w-full px-5 py-1 shadow-sm border-gray-300 rounded-md"/>
            </div>

            <div className="flex flex-row w-full justify-between items-center">
              <label htmlFor="denounced-state" className="font-semibold w-64 mr-4">Estado</label>
              <input type="text" name="denounced-state" className="w-full px-5 py-1 shadow-sm border-gray-300 rounded-md"/>
            </div>

            <div className="flex flex-row w-full justify-between items-center">
              <label htmlFor="denounced-municipality" className="font-semibold w-64 mr-4">Municipio</label>
          ...
          {/* Datos del hecho */}
          <fieldset  className="relative flex flex-col bg-gray-200 pt-2 pb-7 px-12 w-full space-y-4 text-lg">
            <legend className="text-2xl font-semibold">Datos Generales del Hecho</legend>
            
            <div className="flex flex-row w-full justify-between items-center">
              <label htmlFor="event-type" className="font-semibold w-64 mr-4">*Tipo de Violación</label>
            ...
            <div className="flex flex-row w-full justify-between justify-center">
              <label htmlFor="event-priority" className="font-semibold w-64 mr-4">*Prioridad</label>
            ...
            <div className="flex flex-col w-full justify-between">
              <label htmlFor="event-description" className="font-semibold w-64 mr-4">*Descripción del Hecho</label>
            ...
            <div className="flex flex-col w-full justify-between">
              <label htmlFor="event-location" className="font-semibold w-64 mr-4">*Localización del Hecho</label>
            ...
            <div>
              <label htmlFor="event-images" className="font-semibold w-64 mr-4">Imágenes</label>
